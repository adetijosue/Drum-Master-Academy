      ...
      <div className={isDashboard ? "w-full" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"}>
        ...
        {!isDashboard ? (
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            ...
            >
              {/* YouTube Channel CTA */}
              <a
                href="https://www.youtube.com/@josueadeti"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold bg-red-600/10 hover:bg-red-600/20 text-red-500 border border-red-500/10 transition-all hover:scale-[1.02]"
              >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-red-600/10 hover:bg-red-600/20 text-red-500 border border-red-500/20 transition-all"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-stretch">
          ...
          <div className="lg:col-span-4 flex flex-col h-[380px] lg:h-[480px]">
            ...
            <div className="mt-4 p-4 rounded-xl border border-red-500/20 bg-red-950/10 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-red-600/10 flex items-center justify-center text-red-500 border border-red-500/20 shrink-0">
                  <Youtube className="w-5 h-5 fill-current" />
                </div>
                <div className="text-left">
                  <h4 className="text-xs font-bold text-white">Chaîne de Josué ADETI</h4>
                  <p className="text-[10px] text-zinc-400 leading-tight">Coaching, covers et tutoriels exclusifs.</p>
                </div>
              </div>
              <a
                href="https://www.youtube.com/@josueadeti"
                target="_blank"
                rel="noopener noreferrer"
                className="px-3 py-1.5 rounded-lg bg-red-600 hover:bg-red-500 text-white text-[11px] font-bold transition-colors whitespace-nowrap shadow-md shadow-red-600/20"
              >
                Découvrir
              </a>
            </div>
